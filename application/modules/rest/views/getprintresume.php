...
KETUA TIM PEMERIKSAAN KESEHATAN<br/><!--'.$sghdfs->golongan.'<br/><br/><br/>--><img src="'.@base_url('qr/Q1-'.$abs->kode_transaksi.'.png').'" style="width:80px"><br/>'.@$sghdfs->nm_dok.'<br />'.@$sghdfs->pangkat.'
</div>
</td>
</tr>
</table>
