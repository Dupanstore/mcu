...
?>
			...
			<table width="100%" style="margin:5px 0 0 0;font-size:12px;font-family:arial;" cellpadding="2px">
						...
						<table width="100%" style="font-size:12px;font-family:arial;" >
							<tr>
								...
								<td style="vertical-align:top;">
									...
									<!--<pre style="border:0;background:#ffffff;font-size:12px;font-family: arial;margin:0;padding:0;"><?=@$getAnamnesa?><br /></pre>-->
								</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
				...
				<tr style="border-top:solid 1px #000000;border-bottom:solid 1px #000000">
					<td colspan="7">
		<!--edit aby-->		<table width="100%" style="font-size:12px;font-family:arial;margin:0 0 5px 0;">
		...
		<!--edit aby-->		<table width="100%" style="font-size:12px;font-family:arial;margin:0 0 5px 0;">
							<tr>	
								<td width="1%">C.</td>
								<td width="1%">1.</td>
								<td width="10%">Chamber</td>
								<td>: <?=@$pemeriksaantambahan['Chamber-FI']?></td>
								<td width="10%"></td>
								<td rowspan="5">
									<div align="right">
										<br/>
		<!--edit aby tdnya 80%-->					<table width="70%" style="font-size:12px;font-family:arial;margin:0 0 5px 0;border:solid 1px #000000;">
											<tr>
	...
	<!--edit aby-->			<table width="100%" style="font-size:12px;font-family:arial;margin:0 0 5px 0;">
							<tr>	
								...
								?>
	<!--edit aby-->						<table width="100%" style="font-size:12px;font-family:arial;margin:0;">
									<?php 
			...
			<br />
			<button class="btn btn-info btn-sm" onclick="window.open('https://daftar.lakesprasaryanto.com/user/printresume/?idm=<?=@$idmcu?>&idp=<?=@$idpaket?>')">Print Resume</button>