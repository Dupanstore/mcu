...
<head>
	...
	<script type="text/javascript" src="<?=@base_url('newasset/antrian/js/jquery.min.js')?>">jQuery.noConflict();</script>
	<script type="text/javascript" src="<?=@base_url('newasset/antrian/js/jquery.easyui.min.js')?>">jQuery.noConflict();</script>
	<link rel="stylesheet" type="text/css" href="<?=base_url('newasset/antrian/css/bootstrapp.min.css')?>">
	...
	<link href="<?=@base_url('video/pendaftaran')?>/video-js.css" rel="stylesheet" type="text/css">
	 <style media="screen">
			...
			body {
              overflow:hidden;
			  background: #f1f1f1 url('<?=@base_url()?>/newasset/antrian/img/r_logo.png') repeat;
            }
        </style>	
	...
	<div class="main-wrapper">
            <div class="col-xs-12" style="height: 15vh; padding: 10px 5px; background-color: #FFF; border-top: 5px solid #eb8a1b;">
                <div class="col-xs-12" style="height: 100%;">
                    <div class="col-xs-1" style="height: 100%; text-align: center; justify-content: center; align-content: center; flex: 1; display: flex; flex-direction: column;">
                        <div class="lineHeightDiv" align="center">
                            <img src="<?=base_url('assets/img/icon.png')?>" class="img img-responsive" style="height: 90px;">
                        </div>
                    </div>
                    <div class="col-xs-8" style="height: 100%;">
                        <div style="height: 100%; width: 100%; color: #173169; font-weight: bold; justify-content: center; align-content: center; flex: 1; display: flex; flex-direction: column; padding-top: 10px; text-shadow: 1px 2px 4px rgba(51, 51, 51, 0.3);">
                            <span style="font-size: 30px;">Lakespra dr.Saryanto </span>
                            <p style="font-size: 25px;">MT Haryono St No.41, RT.1/RW.1, Cikoko, Pancoran</p>
                        </div>
                    </div>
