...
<html lang="en">
	<!--<head>-->
		...
		<link rel="shortcut icon" href="<?=base_url('newasset/antrian/img/favicon.ico')?>">
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<meta name="author" content="Smokers">
		<script type="text/javascript" src="<?=base_url('newasset/antrian/js/jquery-1.8.0.min.js')?>">jQuery.noConflict();</script>
		<script type="text/javascript" src="<?=base_url('newasset/antrian/js/jquery.easyui.min.js')?>">jQuery.noConflict();</script>
		<script type="text/javascript" src="<?=base_url('newasset/antrian/js/bootstrap.js')?>"></script>
		<link rel="stylesheet" type="text/css" href="<?=base_url('newasset/antrian/css/bootstrap/easyui.css')?>">
		<link rel="stylesheet" type="text/css" href="<?=base_url('newasset/antrian/css/bootstrap.css')?>">
		<link rel="stylesheet" type="text/css" href="<?=base_url('newasset/antrian/css/bootstrap-responsive.css')?>">
		<link rel="stylesheet" type="text/css" href="<?=base_url('newasset/antrian/css/sticky-footers.css')?>">
		<link rel="stylesheet" type="text/css" href="<?=base_url('newasset/antrian/css/icon.css')?>">
	<!--</head>-->
		<style>
	h1,h2,p,a{
