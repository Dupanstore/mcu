	...
	<legend>Master Data Pemeriksaan:</legend>
		<table style="width:100%" cellpadding="2px;">
			...
			<tr>
				<td>Order Form:</td>
				<td>
					<small><i>Order Form digunakan untuk order cetak di form pendaftaran (TANDA TELAH MELAKSANAKAN PEMERIKSAAN)</i></small><br />
					<select name="order_form_baru" style="width:20%;" >
					<?php
						//ambil kodenya yaaa
					?>
					<?php foreach(range(0, 100) as $va){ 
