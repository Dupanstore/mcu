<div class="easyui-layout" data-options="fit:true" id="keipalingawallaporan">
		...
		<div data-options="region:'east',split:true,footer:'#datakeseatan_pasien_kerjakelainan2_panel1_toolbar',iconCls:'icon-lock'" title="" style="width:65%;background:#AFC9EC;">
