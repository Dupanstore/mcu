...
<head>
	...
	<script type="text/javascript" src="<?=@base_url('assets/js/jquery.min.js')?>">jQuery.noConflict();</script>
	 <script type="text/javascript" src="<?=@base_url('template')?>/dist/js/jquery-ui.min.js">jQuery.noConflict();</script>
...
<body class="easyui-layout">
	...
	<div id="mm2" style="width:250px;">
		...
		<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Pendaftaran Konsultasi', '<?=@base_url($this->u1 . '/revisinomorurut')?>')">Revisi Nomor Urut</a></div>
		<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('List Booking Online', '<?=@base_url($this->u1 . '/listbookingonline')?>')">List Booking Online</a></div>
	...
	<div id="mm4" style="width:250px;">
		...
		<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Pembayaran Pasien', '<?=@base_url($this->u1 . '/pembayaranpasiendua')?>')">Pembayaran Pasien</a></div>
	...
	<div id="mm1" style="width:250px;">
		...
		<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Diagnosa Penyakit', '<?=@base_url($this->u1 . '/mastericd')?>')">Diagnosa Penyakit </a></div>
		...
		<div>
            ...
            <div>
				...
				<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Master Paket Konsul', '<?=@base_url($this->u1 . '/masterpaketkonsul')?>')">Master Paket Konsul</a></div>
            </div>
        </div>
		<div>
            <span>Lain-lain</span>
		...
		<div>
            <span>Lakespra Online</span>
            <div>
				<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Master Banner', '<?=@base_url($this->u1 . '/databanpaket')?>')">Paket</a></div>
				<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Master Banner', '<?=@base_url($this->u1 . '/masteraeroklinik')?>')">Aeroklinik</a></div>
				<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Master Kategori', '<?=@base_url($this->u1 . '/datakatspesialis')?>')">Spesialis</a></div>
				<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Master Banner', '<?=@base_url($this->u1 . '/masterbanner')?>')">Banner</a></div>
				<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Master Kategori', '<?=@base_url($this->u1 . '/datakatberita')?>')">Kategori</a></div>
				<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Master Informasi', '<?=@base_url($this->u1 . '/informasidata')?>')">Informasi</a></div>
				<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Master Data Dokter', '<?=@base_url($this->u1 . '/onlinedatadokter')?>')">Data Dokter</a></div>
				<div><a href="javascript:void(0)" style="text-decoration:none;color:#333333;font-size:13px;" onclick="newtabnya('Pengaturan', '<?=@base_url($this->u1 . '/pengaturanonline')?>')">Pengaturan</a></div>
            </div>
        </div>
		<div>
