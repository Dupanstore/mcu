       <div class="easyui-tabs" style="width:100%">
        <div title="Indonesia" style="padding:0px">
			...
			<div align="center">
					...
					<button type="button" onclick="window.open('<?=@base_url($this->u1.'/cetaknewbukutemplate')?>/?kode_transaksi=<?=@$_GET['kode_transaksi']?>&id_paket=<?=@$_GET['id_paket']?>')">Cetak Model Terbaru</button>
					<button type="button" onclick="window.open('<?=@base_url($this->u1.'/cetaknewbukutemplate')?>/?kode_transaksi=<?=@$_GET['kode_transaksi']?>&id_paket=<?=@$_GET['id_paket']?>&kop=Y')">Cetak Model Terbaru + Kop</button>
					</div>
		...
		<div align="center" style="padding:10px;">
		<button type="button" onclick="window.open('<?=@base_url($this->u1.'/cetaknewbukutemplate')?>/?kode_transaksi=<?=@$_GET['kode_transaksi']?>&id_paket=<?=@$_GET['id_paket']?>&lang=en')">Cetak Model Terbaru</button>
		<button type="button" onclick="window.open('<?=@base_url($this->u1.'/cetaknewbukutemplate')?>/?kode_transaksi=<?=@$_GET['kode_transaksi']?>&id_paket=<?=@$_GET['id_paket']?>&lang=en&kop=Y')">Cetak Model Terbaru + Kop</button>
		</div>
