<?php
	...
	$sff = "select a.id_reg_detpem, a.hasilnya, a.adakelainan, a.ketkelainanlainnya, b.tgl_awal_reg from tb_register_detailpemeriksaan a, tb_register b where a.kode_transaksi=b.kode_transaksi ";
