<?php
	...
	if(isset($_GET['typecetak'])){
		...
		$que  = " select a.no_filemcu, a.id_paket, a.kode_transaksi, a.no_reg,a.id_reg, a.tgl_awal_reg, b.nip_nrp_nik, b.id_pas, b.tmp_lahir_pas, b.tgl_lhr_pas, b.nm_pas, b.pangkat_pas, b.jabatan_pas, b.id_jawatan, c.nm_jawatan, e.nm_dinas, e.id_dinas, f.id_paket, f.nm_paket, f.harga_paket ";
...
<style>
	...
	.bordernone td{
		...
		<table style="width:100%;border-spacing:0;">
			<tr>
				...
				<td rowspan="2" style="vertical-align:middle;text-align:center;">DEBET</td>
				<td rowspan="2" style="vertical-align:middle;text-align:center;">KREDIT</td>
			</tr>
			<tr>
				<td  style="vertical-align:middle;text-align:center;">NAMA</td>
				<td   style="vertical-align:middle;text-align:center;">PAKET/KONS</td>
			</tr>
			<tr>
		...
		<?php
				...
				foreach($abd as $bs){
					...
					//print_r($abg);
					if($abg){
						$ttlbwhh[$bs->kode_transaksi.'PKKT'.$bs->id_paket] = $bs->harga_paket;
						foreach($abg as $bsd){
								...
								$ttlbwhh[$bs->kode_transaksi.'TNDDD'.$bsd->id_tind] = $harga;
						}
						//print_r($newarray);
						//die();
					}
	...
	<tr>
			...
			<td style="vertical-align:middle;text-align:center;">
				<b><?=@is_no_rp(array_sum($ttlbwhh))?></b>
			</td>
			<td style="vertical-align:middle;text-align:center;">
