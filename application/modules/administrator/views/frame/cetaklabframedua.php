			...
			if($bs->id_ins == "2"){
				//yang dihalaman 2 hanya hematologi selain itu dihalaman 3 ya
					...
					foreach($ssv as $hsd){
						...
						//print_r($hsd->hasilnya);
						$hsd->hasilnyadua = $hsd->hasilnya;
						if(is_array($hsd->hasilnya)){
							$hsd->hasilnya = "";
						}
...
<html>
	...
	<body style="background:#777777;">
			...
			<div class="page">
											<?php
												$en_pemeriksa = "Pemeriksa";
												$en_kesimpulan = "Kesimpulan";
												$en_stakes = "Stakes";
												$en_nolab = "No Lab.";
												...
												if(isset($_GET['lang'])){
													$en_pemeriksa = "Examiner";
													$en_kesimpulan = "Conclusion";
													$en_stakes = "Health Status";
													$en_nolab = "Lab. Number";
													...
													$en_jenkel = "Sex";
													$en_pngkt = "Grade / Security Number";
													...
													<tr>
														...
														?>
																	<tr>
																		...
																		<?php 
																			if(!is_array($pages5[$um]['kiri'][$ke][$ju][$mo][$bb])){
																				echo $pages5[$um]['kiri'][$ke][$ju][$mo][$bb];
																				//echo $bb;

																			}
																		?>
																		<B><?=@$pages7[$um]['kiri'][$ke][$ju][$mo][$bb]?></B></td>
									...
									<td WIDTH="58%">
										<div align="left">
											...
											<?php
												...
												if($abs->tipe_dinas == "D"){
													echo "<br /><b>".$en_stakes.": ".$ash[0]->val_stakes."</b>";
												}
												if($abs->tipe_dinas == "N"){
