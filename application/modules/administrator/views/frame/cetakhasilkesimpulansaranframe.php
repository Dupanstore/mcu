							...
							<tr>	
								...
								<td>
									<div align="center" style="margin:10px 0 0 0;">
										KEPALA LAKESPRA DR SARYANTO<br/><!--<?=@$sghdfs->golongan?><br/><br/><br/>--><img src="<?=@base_url('qr/Q1-'.$abs->kode_transaksi.'.png')?>" style="width:15%"><br/><?=@$sghdfs->nm_dok?><br /><?=@$sghdfs->pangkat?>
									</div>
								</td>
							</tr>
						</table>
