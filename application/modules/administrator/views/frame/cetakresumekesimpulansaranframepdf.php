...
if($abs->def_ttd > 0){
 ...
 if(!$_GET['noprint']){
$html   .= '<td style="vertical-align:top;"><small>Halaman '.$um.' of '.$akhirpage.'<br />'.$abs->nm_pas.' ['.$abs->no_reg.']</small></td>
...
KEPALA LAKESPRA DR SARYANTO<br/><!--'.$sghdfs->golongan.'<br/><br/><br/>--><img src="'.@base_url('qr/Q1-'.$abs->kode_transaksi.'.png').'" style="width:95px;"><br/><span >'.$sghdfs->nm_dok.'</span><br />'.$sghdfs->pangkat.'
</div>
</td>';
}
}
