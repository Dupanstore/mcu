...
<div <?=@$dismm?>>
<?php
	$dfr = "select a.def_ttd, a.keluhan_utama, a.no_reg, a.tgl_awal_reg, a.kode_transaksi, a.no_filemcu, c.kawin_pas, c.nm_pas, c.bangsa_pas, c.pangkat_pas, c.jenkel_pas, c.alamat_pas, c.no_tlp_pas, c.nip_nrp_nik, c.nm_pekerjaan, c.gol_darah, c.jabatan_pas, c.tgl_lhr_pas, c.tmp_lahir_pas, d.nm_jawatan, nm_dinas ";
	...
	//print_r($kelainangigi);
					...
					//ambil untuk struktur gigi
						$jkjkbs = "select hasilnya, posisi_struktur_gigi from tb_register_detailpemeriksaan where 1=1 and kode_transaksi='".$_GET['kode_transaksi']."' and id_paket='".clean_data($_GET['id_paket'])."' and apakah_struktur_gigi='Y' ";
