...
<td width="73.1%" style="border-left:solid 1px #000000;padding:2px;border-bottom:solid 1px #000000;">'.@htmlentities($getDiagnosalain3[$wy]).'</td>
</tr>';
}
$html .= '</table>';
...
KEPALA LAKESPRA DR SARYANTO<br/><!--'.$sghdfs->golongan.'<br/><br/><br/>--><img src="'.@base_url('qr/Q1-'.$abs->kode_transaksi.'.png').'" style="width:80px"><br/>'.@$sghdfs->nm_dok.'<br />'.@$sghdfs->pangkat.'
</div>
</td>
</tr>
</table>
