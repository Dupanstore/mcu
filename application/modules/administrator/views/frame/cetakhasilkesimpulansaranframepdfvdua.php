...
<table style="font-size:13px;width:100%">
	...
	<tr >
	<td colspan="3" ><b style="border-bottom:1px solid #000000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LAKESPRA '.@is_fixname().'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td></tr>
</table>
';

$html .= '
<table style="font-size:13px;width:100%" cellpadding="3">
	<tr><td colspan="3"><div align="center"><br /><b class="underlined">RESUME DATA MEDIS</b></div></td></tr>
</table>
';

$html .= '
<table width="100%" style="font-size:13px;border-spacing:0;font-family: arial;" cellpadding="1px">
<tr>
...
$sdcd = '<table style="width:100%;font-size:13px;font-family:arial;">';
...
$html .= '
<br /><br />
<table width="100%" style="font-size:13px;font-family:arial;" cellpadding="2px">
<tr>
...
$html .= '
<br /><br />
<table width="94.7%" style="font-size:13px;font-family:arial;" >
<tr>	
...
<div align="left">
<br />
<table width="100%" style="font-size:13px;font-family:arial;margin:0 0 5px 0;">
<tr>
...
$html .= '<table width="100%"  style="font-size:13px;font-family:arial;margin:0;">';
...
<td width="10%"></td>
<td width="54%">
<div align="center" style="margin:13px 0 0 0;">
KEPALA LAKESPRA DR SARYANTO<br/><!--'.$sghdfs->golongan.'<br/><br/><br/>--><img src="'.@base_url('qr/Q1-'.$abs->kode_transaksi.'.png').'" style="width:90px"><br/>'.@$sghdfs->nm_dok.'<br />'.@$sghdfs->pangkat.'
</div>
</td>
</tr>
</table>
...
echo "<div style='margin:10px;'>". $html ."</div>";
die();
?>
