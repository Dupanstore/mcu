<?php
	$dfr = "select a.qr_code_keys, a.id_reg, a.no_lab_mcu, a.no_reg, a.tgl_awal_reg, a.tglverifrapid, a.kode_transaksi, a.no_filemcu, c.jenkel_pas, c.nm_pas, c.pangkat_pas, c.no_tlp_pas, c.nip_nrp_nik, c.gol_darah, c.jabatan_pas, c.tgl_lhr_pas, c.tmp_lahir_pas, d.nm_jawatan, nm_dinas, e.tipe_dinas ";
	...
	if(!empty($abs->qr_code_keys)){
		...
		$params['data'] = "https://qr.lakesprasaryanto.com/?pid=".$qkeysx;
		$params['level'] = 'H';
		$params['size'] = 2;
		$params['savename'] = FCPATH.'/qr/Q2-'.$abs->kode_transaksi.'.png';
			...
			<div class="page">
									...
									<tr style="border:none;">
										<td colspan="3" style="border:none;">
											...
											<table width="100%" style="font-size:14px;border-spacing:0;font-family:arial;margin:20px 0 0 0;" cellpadding="14px" >
												...
												<h5><p class="text-center"><span style="border-bottom:1px solid #666666;font-size:14px;margin-top:20px;"><br />Pelaporan Hasil Rapid Swab Antigen SARS-CoV-2</p></h5>
					...
					<table width="100%" style="font-size:14px;border-spacing:0;font-family:arial;">
						<tr>
							<td WIDTH="40%">
								<div align="center">
									<?php echo '<img src="'.@base_url('qr/Q2-'.$abs->kode_transaksi.'.png').'" style="width:40%">';?>
								</div>
							</td>
								<td width="20%"></td>
								<td>
