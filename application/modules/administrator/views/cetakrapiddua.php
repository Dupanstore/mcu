											...
											<table width="100%" style="font-size:14px;border-spacing:0;font-family:arial;margin:20px 0 0 0;" cellpadding="14px" >
												...
												<table width="100%" id="tbcdn" style="font-size:14px;border-spacing:0;font-family: arial;" cellpadding="3px">
													...
													<tr>
														...
														<td colspan="10"><br /><p>Menerangkan dengan sebenar benarnya bahwa:</p></td>
													</tr>
													<tr>
														<td> </td>
														<td width="15%">Nama </td>
														<td width="2%">:</td>
														<td><?=@$pangktpas?> <?=@$abs->nm_pas?> [<?=@$abs->no_reg?>]</td>
													...
													<tr>
														...
														<td>Umur</td>
														<td>:</td>
														<td><?=@get_umur($abs->tgl_lhr_pas)?> [<?=@date('d/m/Y', strtotime($abs->tgl_lhr_pas))?>] &nbsp; &nbsp; &nbsp; Kesatuan: <?=@$abs->kesatuan_pas?></td>
													...
													<tr>
														<td colspan="10"><br /><p>&nbsp; &nbsp; &nbsp;Adalah benar yang bersangkutan melaksanakan Rapid Test Antibodi Covid-19 di Lakespra dr. Saryanto dengan hasil <?=@$hasill?></p></td>
													</tr>
													<tr>
