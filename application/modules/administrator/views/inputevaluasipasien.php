<?php
	//print_r($_GET);
	$que  = "select a.publikasikan, a.no_reg, a.tgl_awal_reg, a.id_reg, a.no_filemcu, b.nip_nrp_nik, b.id_pas, b.nm_pas, b.no_tlp_pas, b.jenkel_pas, b.gol_darah, b.tgl_lhr_pas from tb_register a, tb_pasien b where a.no_reg=b.no_reg ";
...
<div class="easyui-layout" data-options="fit:true" id="detailevaluasipasienpanel">
               ...
               <form method="POST" id="detailevaluasipasienpanel_form1" action="<?=base_url($this->u1 .'/'. $this->u1 .'_action/simpandetailevaluasipasien')?>">
				   ...
				   <table style="width:90%">
					<tr>
						...
						<td width="1%">:</td>
						<td>
							<input type="checkbox" <?=@$sbvdd?> onclick="publikasikan('<?=@$this->u3?>')">
						</td>
					</tr>
					<tr>
	...
	<script type="text/javascript">
		...
		function detailevaluasidata_simpandata(){
			...
			function publikasikan(kod){
				
				$.post('<?=@base_url($this->u1 .'/publikasikan')?>',{
					kod:kod,
				},function(result){ 
					//alert(result);
				}); 
