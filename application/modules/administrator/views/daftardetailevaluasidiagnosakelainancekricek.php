			...
			if($ssv){
				...
				if($bs->id_ins == "3"){
					...
					if($bs->stakes_tindakan != ""){
						...
						$stttke = "-";
						if(!empty($bs->set_stakes)){
							$stttke = $bs->set_stakes;
						}
						$awalstakes[$stttke][$bs->nm_ins] = $bs->val_stakes;
						$kesimpulanperiksa[$stttke][$bs->nm_ins] = $sebelumtambahan . $bs->kesimpulan_pemeriksaan;
						$saranperiksa[$stttke][$bs->nm_ins] = $bs->saran_pemeriksaan;
						$awalstakes1[$stttke][$bs->nm_ins] = "Instalasi";
						$awalstakes2[$stttke][$bs->nm_ins] = $bs->order_evaluasi;
						$awalstakes3[$stttke][$bs->nm_ins] = $bs->nm_ins;
						$awalstakes4[$stttke][$bs->nm_ins] = implode(", ", $looperrorx[$bs->nm_ins]);
					}
				}
				//print_r($awalstakes4);
			}
