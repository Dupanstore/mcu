		...
		if($duslam){
			...
			if($anhs){
				if($anhs[0]->riwayat_kesehatan_pasien != ""){
					$shn .= "\nRKP: ". $anhs[0]->riwayat_kesehatan_pasien;
				}
				if($anhs[0]->riwayat_kesehatan_keluarga != ""){
					$shn .= "\nRKK: ".$anhs[0]->riwayat_kesehatan_keluarga;
				}
			}
		}
...
<table style="width:100%">
	<tr>
		<td style="width:35%"><textarea cols="80" rows="10" style="width:97%;border:solid 1px #cccccc;background:#eaeaea" disabled="true"><?=@$standarisi?></textarea></td>
		<td style="width:1%"></td>
		<td><textarea cols="80" id="edito1" name="anamnesanyaya" rows="10" style="width:97%;border:solid 1px #cccccc;"><?=@$shn?></textarea></td>
	</tr>
</table>
