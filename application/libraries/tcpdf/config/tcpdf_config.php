 ...
 */
define ('PDF_HEADER_LOGO', 'logorsmmbulat.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Rumah Sakit MM Indramayu');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Jl. Letjend. Soeprapto No. 292 Kepandean Indramayu - Jawa Barat 45214\nEmail : rumahsakit@rsmm-indramayu.id Telp:(0234)277632/33/34");
