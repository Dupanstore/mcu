		...
		<?php } ?>
			<tr>
				...
				<td colspan="3">
					...
					<a href="javascript:void(0)"  iconCls="icon-print" class="easyui-linkbutton" onclick="cetakrapidtest()"><b>Rapid Test</b></a>
					<a href="javascript:void(0)"  iconCls="icon-print" class="easyui-linkbutton" onclick="cetakhasillabdua()"><b>Cetak Hasil Mode 1</b></a>
					<a href="javascript:void(0)"  iconCls="icon-print" class="easyui-linkbutton" onclick="cetakhasillabtiga()"><b>Cetak Hasil Mode 2</b></a>
					<a href="javascript:void(0)"  iconCls="icon-print" class="easyui-linkbutton" onclick="cetakhasillabempat()"><b>Cetak Hasil Mode 2 (Inggris)</b></a>
				</td>
				<td colspan="2">
