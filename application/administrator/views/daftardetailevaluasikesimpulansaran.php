<?php
	...
	$sga = "select a.val_stakes, b.nm_tind, b.stakes_tindakan, d.set_stakes, d.id_ins, d.nm_ins, e.nm_grouptindakan, e.order_evalusi_group from  tb_register_pemeriksaan a, tb_tindakan b, tb_instalasi d, tb_grouptind e ";
...
<table style="width:100%">
		...
		<td colspan="2">
					<table style="width:100%" class="tableeasyui">
						...
						<tr>
							...
							<td style="width:30%">
								<select name="isinya[saran][<?=@$gi?>]"  style="width:100%">
									<option value=""></option>
									<?php 
	...
	<tr>
		...
		<td>
			...
			<select  id="keterangan_sehat" name="isinya[keterangan_sehat]" style="width:40%;">
									<option value="">-</option>
									<?php 
...
<button style="cursor:pointer" type="button" onclick="simpankesimpulansaran()" style="width:100%;">Simpan Kesimpulan dan Saran</button>
<?php if($pangkasnoreg == "D"){ ?>

<button style="cursor:pointer" type="button" onclick="cetakhasilpemeriksaan()" style="width:100%;">Cetak Resume</button>
<button style="cursor:pointer" type="button" onclick="cetakpilihan('cetakhasilkesimpulansaranframepdf', 'Cetak Resume PDF')" style="width:100%;">Cetak Resume PDF</button>
<button style="cursor:pointer" type="button" onclick="cetakresumepemeriksaan('cetakresumekesimpulansaranframe')" style="width:100%;">Cetak Hasil Pemeriksaan</button>
<button style="cursor:pointer" type="button" onclick="cetakresumepemeriksaan('cetakresumekesimpulansaranframepdf')" style="width:100%;">Cetak Hasil Pemeriksaan (Mode 2)</button>
<?php } else { ?>
