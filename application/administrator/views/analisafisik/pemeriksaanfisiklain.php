<div id="wedusss" style="min-width: 310px; height: 320px; margin: 0 auto"></div>
		<?php
			//ambil datanya yaaa
			//print_r($_GET);
			$fghb = "select  CONCAT(det_nm_pemeriksaan, ' -> ', val_reg_pemeriksaan) as detail_pemfisiklain , count(id_reg_pem) as newkode from  tb_register_pemeriksaan, tb_pemeriksaan, tb_register, tb_pasien ";
