<?php
	if($this->uri->segment(3)){
		...
		$this->db->from('tb_paket_meta');
		$this->db->where('id_paket', $this->uri->segment(3));
		...
		$que 	 = "select * from tb_paket_meta, tb_tindakan, tb_grouptind where tb_paket_meta.id_tind=tb_tindakan.id_tind and tb_tindakan.kd_grouptind=tb_grouptind.kd_grouptindakan ";
		if (@!empty($_POST['cari'])){
		...
		$que 	.= " and id_paket='".$this->uri->segment(3)."' ";
