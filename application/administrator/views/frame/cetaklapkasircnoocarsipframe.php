...
<style>
	th, td {
		...
		<div align="center">
			<h4>DAFTAR KARYAWAN CNOOC SES LTD<br />YANG MELAKSANAKAN MEDICAL CHECK UP<br /> DI LAKESPRA SARYANTO<br /><?=@$pak1[0]->nm_paket?> <?=@$jaw1[0]->nm_jawatan?> <?=@$din?> <?=@$bay?> <?=@$tglawal?> - <?=@$tglakhir?></h4>
		</div>
