<?php
	...
	if(isset($_GET['type'])){
		...
		$que  = " select a.id_paket, a.kode_transaksi, a.no_reg, DATE_FORMAT(tgl_awal_reg, '%d/%m/%Y %H:%i:%s') as newtglnya, a.id_reg, a.tgl_awal_reg, b.nip_nrp_nik, b.id_pas, b.tmp_lahir_pas, b.tgl_lhr_pas, b.nm_pas, b.pangkat_pas, b.jabatan_pas, b.id_jawatan, c.nm_jawatan, e.nm_dinas, e.id_dinas ";
		...
		$que 	.= " and (e.id_dinas='43' OR e.id_dinas='51' OR e.id_dinas='44' OR e.id_dinas='45' OR e.id_dinas='46' OR e.id_dinas='47' OR e.id_dinas='48' OR e.id_dinas='49' OR e.id_dinas='63' OR e.id_dinas='80') ";
...
<style>
	th, td {
		...
		<div align="center">
			<h4>LAPORAN HASIL CASIS TNI AU<br />KORPS PENERBANG NAVIGATOR ILA JMU, MEDEX JMU<br /><?=@$tglawal?> - <?=@$tglakhir?></h4>
		</div>
		...
		<tr>
			<td><?=@$so?></td>
			<td><?=@date("d/m/Y", strtotime($bs->tgl_awal_reg))?></td>
			<td><?=@$bs->nm_pas?><br /><?=@$bs->tmp_lahir_pas?>, <?=@date("d/m/Y", strtotime($bs->tgl_lhr_pas))?></td>
