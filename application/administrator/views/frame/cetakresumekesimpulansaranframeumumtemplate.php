...
<?php
	...
	$getpemfinal = "select a.adakelainan, a.ketkelainanlainnya, a.hasilnya, b.nomorbuku from tb_register_detailpemeriksaan a, tb_pemeriksaan b where a.id_pem_deb=b.id_pem and a.kode_transaksi='".clean_data($_GET['kode_transaksi'])."'  ";
	...
	$shc = "select id_tind_pem, kesantext  from tb_register_pemeriksaan where  kode_transaksi='".clean_data($_GET['kode_transaksi'])."' ";
						...
						<tr>
							...
							<td width="40%">
								...
								<?php } else if($um == "4") { ?>
									...
									<table width="100%" style="font-size:14px;font-family: arial;border:solid 0PX;">
											<tr>
												<td style="padding:1px;width:34%"><span>Pblackicted Vol</span><br/><span ><i></i></span></td>
												<td width="1%" style="padding:1px;">:</td>
											...
											<tr>
												<td style="padding:1px;"><span>PVR</span><br/><span ><i></i></span></td>
												<td width="1%" style="padding:1px;">:</td>
									...
									<table width="100%" style="font-size:14px;font-family: arial;border:solid 0PX;">
											...
											<tr>
												<td style="padding:2px;" colspan="3"><br /></td>
											</tr>
											<tr>
									...
									<table width="100%" style="font-size:14px;font-family: arial;border:solid 0PX;">
											...
											<tr>
												<td style="padding:2px;width:50%"><span>USG Abdomen </span><br/><span style="border-top:solid 1px #000000;"><i>USG Abdomen</i></span></td>
												<td width="1%" style="padding:2px;">:</td>
												<td style="padding:2px;" colspan="3"><?=@$sethasilpem['12P7']?></td>
											</tr>
											<tr>
												<td style="padding:2px;"><span>USG Mammae</span><br/><span style="border-top:solid 1px #000000;"><i>USG Mammae</i></span></td>
												<td width="1%" style="padding:2px;">:</td>
												<td style="padding:2px;" colspan="3"><?=@$sethasilpem['12P8']?></td>
											</tr>
											<tr>
												<td style="padding:2px;"><span>USG Tyroid</span><br/><span style="border-top:solid 1px #000000;"><i>USG Tyroid</i></span></td>
												<td width="1%" style="padding:2px;">:</td>
												<td style="padding:2px;" colspan="3"><?=@$sethasilpem['12P9']?></td>
											</tr>
									</table>
									...
									<table width="100%" style="font-size:14px;font-family: arial;border:solid 0PX;">
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;" colspan="3"><?=@$sethasilpem['13P5']?></td>
											</tr>
									</table>
									...
									<table width="100%" style="font-size:14px;font-family: arial;border:solid 0PX;">
											...
											<tr>
												<td style="padding:4px;width:35%" colspan="2">
													<span style="border-bottom:solid 1px #000000;">Golongan Darah</span><br/>
													<span ><i>Blood Group</i></span>
												</td>
												<td width="1%" style="padding:4px;">:</td>
									...
									<table width="100%" style="font-size:14px;font-family: arial;border:solid 0PX;">
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;width:25%" ><?=@$sethasilpem['17P1']?></td>
												<td style="padding:4px 4px 4px 4px;" >
													<div align="right">
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;" ><?=@$sethasilpem['17P2']?></td>
												<td style="padding:4px 4px 4px 4px;" >
													<div align="right">
											...
											<tr>
												...
												<td style="padding:4px;">: <?=@$sethasilpem['17P3']?></td>
											</tr>
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;" ><?=@$sethasilpem['17P4']?></td>
												<td style="padding:4px 4px 4px 4px;" >
													<div align="right">
														<span ><200 mg/dL</span>
													</div>
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;" ><?=@$sethasilpem['17P5']?></td>
												<td style="padding:4px 4px 4px 4px;" >
													<div align="right">
														<span >>40 mg/dL</span>
													</div>
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;" ><?=@$sethasilpem['17P6']?></td>
												<td style="padding:4px 4px 4px 4px;" >
													<div align="right">
														<span ><100 mg/dL</span>
													</div>
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;" ><?=@$sethasilpem['17P7']?></td>
												<td style="padding:4px 4px 4px 4px;" >
													<div align="right">
														<span ><150 mg/dL</span>
													</div>
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;" ><?=@$sethasilpem['17P8']?></td>
												<td style="padding:4px 4px 4px 4px;" >
													<div align="right">
														<span ><50 mg/dL</span>
													</div>
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;" ><?=@$sethasilpem['17P9']?></td>
												<td style="padding:4px 4px 4px 4px;" >
													<div align="right">
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;" ><?=@$sethasilpem['17P10']?></td>
												<td style="padding:4px 4px 4px 4px;" >
													<div align="right">
									...
									<table width="100%" style="font-size:14px;font-family: arial;border:solid 0PX;">
													...
													<table width="100%" style="font-size:14px;font-family: arial;border:solid 0PX;">
														...
														<tr>
															...
															<td style="padding:0;" colspan="3">
																<span >Telur Cacing</span>:  <?=@$sethasilpem['20P12']?>
															</td>
														</tr>
													</table>
												</td>
											...
											<tr>
												...
												<td width="1%" style="padding:4px;">:</td>
												<td style="padding:4px;vertical-align:top;" colspan="3">
													Serat Organic: <?=@$sethasilpem['20P13']?>
												</td>
											</tr>
