...
<td width="17%" style="border-top:solid 1px #000000;">Aerofisiologi</td>
...
$html .= '</tr><tr><td style="border:solid 1px #000000;width:30%">'.@date("d/m/Y", strtotime($abs[0]->tgl_awal_reg)).'</td>';
foreach(is_stakes() as $sg){
...
$html .= '<table width="100%" style="font-size:10px;font-family:arial;margin:0 0 5px 0;">
<tr>	
<td width="3%">D.</td>
...
<tr>	
<td width="3%" style="border-bottom:solid 1px #000000;"></td>
<td width="20%" style="border-bottom:solid 1px #000000;"></td>
<td width="1%" style="border-bottom:solid 1px #000000;"></td>
...
KETUA TIM PEMERIKSAAN KESEHATAN<br/><br/><br/><br/>'.@$this->madmin->Get_setting('tim_kesehatan_lakespra').'<br />'.@$this->madmin->Get_setting('tim_kesehatan_jabatan').'
</div>
</td>
</tr>
</table>
...
$pdf->Output('resume_medis'.$abs[0]->no_filemcu.'.pdf', 'I');
die();
