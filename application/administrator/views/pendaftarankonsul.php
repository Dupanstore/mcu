<div class="easyui-layout" data-options="fit:true" id="datadinas_layout1">
		...
		<div data-options="region:'east',split:true,iconCls:'icon-lock'" title="" style="width:50%;background:#CCDCEC;">
				...
				<div id="tableregisterpas_toolbar" style="padding-top:5px;padding-bottom:5px;height:auto">   
						<table style="width:99%">
							<tr>
								...
								<td><button style="cursor:pointer" type="button" onclick="filtercetakdata()" style="width:100%">Cetak Data Registrasi</button></td>
							</tr>
						</table>
				</div>				
		</div>
	...
	<script type="text/javascript">
		$('#tableregisterpas').datagrid({
				url: '<?=@base_url($this->u1.'/jsondataregistrasikonsul')?>',
		});
		$('#panel_daftar1').panel({
