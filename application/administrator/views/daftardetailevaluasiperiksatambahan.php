...
<table>
	<tr>
		...
		<td><textarea cols="80" id="edito1" name="pemeriksaan[Chamber-FI]" rows="2" style="width:99%;border:solid 1px #cccccc;"><?=@$newsatu['Chamber-FI']?></textarea></td>
	</tr>
	<tr>
		<td>Psikologi</td>
		<input type="hidden" name="id_res[Psikologi]" value="<?=@$iddata['Psikologi']?>">
		<td><textarea cols="80" id="edito1" name="pemeriksaan[Psikologi]" rows="2" style="width:99%;border:solid 1px #cccccc;"><?=@$newsatu['Psikologi']?></textarea></td>
	</tr>
	<tr>
		<td>Psikiatri</td>
		<input type="hidden" name="id_res[Psikiatri]" value="<?=@$iddata['Psikiatri']?>">
		<td><textarea cols="80" id="edito1" name="pemeriksaan[Psikiatri]" rows="2" style="width:99%;border:solid 1px #cccccc;"><?=@$newsatu['Psikiatri']?></textarea></td>
	</tr>
	<tr>
		<td>Kesamaptaan</td>
		<input type="hidden" name="id_res[Kesamaptaan]" value="<?=@$iddata['Kesamaptaan']?>">
		<td><textarea cols="80" id="edito1" name="pemeriksaan[Kesamaptaan]" rows="2" style="width:99%;border:solid 1px #cccccc;"><?=@$newsatu['Kesamaptaan']?></textarea></td>
	</tr>
	<tr>
		<td>BC</td>
		<input type="hidden" name="id_res[BC]" value="<?=@$iddata['BC']?>">
		<td><textarea cols="80" id="edito1" name="pemeriksaan[BC]" rows="2" style="width:99%;border:solid 1px #cccccc;"><?=@$newsatu['BC']?></textarea></td>
	</tr>
	<tr>
		<td></td>
