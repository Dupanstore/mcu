...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Menampilkan {from} - {to} dari {total} data",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.panel.defaults={id:null,title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,tools:null,href:null,loadingMessage:"<style>body{ opacity:0.6;}</style><div align='center' style='padding:10px;color:#666666;font-size:12px;'><img src='../assets/img/diag.png' width='30px' style='opacity:0.4'/><br /><b>Sistem Informasi Manajemen Rumah Sakit<br /><small><img src='../assets/img/preload.gif' width='20px'/> Loading Halaman....</small></b></div>",extractor:function(data){
var _229=/<body[^>]*>((.|[\n\r])*)<\/body>/im;
